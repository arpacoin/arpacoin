...
int nAnonymizeArpaCoinAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ArpaCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ArpaCoin
    // Mac: ~/Library/Application Support/ArpaCoin
    // Unix: ~/.ArpaCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ArpaCoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ArpaCoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ArpaCoind.pid"));
